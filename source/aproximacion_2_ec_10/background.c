...
int background_functions(
  ...
  //CMADE
  //Aproximacion ec 11 Maple file
  //Prueba_1
  /*if(a>=exp(-8.0)){
    pvecback[pba->index_bg_H] = sqrt(rho_tot-pvecback[pba->index_bg_rho_lambda] + pvecback[pba->index_bg_rho_lambda]/a -pba->K/a/a);
  }
  else{
    pvecback[pba->index_bg_H] = sqrt(rho_tot-pvecback[pba->index_bg_rho_lambda] +
                                pvecback[pba->index_bg_rho_lambda]*exp(-8.0)/a/a -pba->K/a/a);
  }*/ //Aproximation 1
  //Prueba_2
  //if(a<exp(-8.0)){
  //  pvecback[pba->index_bg_H] = sqrt(rho_tot-pvecback[pba->index_bg_rho_lambda] +
  ...
  //  pvecback[pba->index_bg_H] = sqrt(rho_tot-pvecback[pba->index_bg_rho_lambda] + pvecback[pba->index_bg_rho_lambda]/a -pba->K/a/a);
  //}
  //Aproximacion 2 17-06-21
  pvecback[pba->index_bg_H] = sqrt(rho_tot-pvecback[pba->index_bg_rho_lambda] +
                              pvecback[pba->index_bg_rho_lambda]/pow(a,pba->om_cmade) -pba->K/a/a);
  ...
  /*if(a>=exp(-8.0)){
    ...
    pvecback[pba->index_bg_H_prime] = - (3./2.) * (rho_tot-pvecback[pba->index_bg_rho_lambda]+pvecback[pba->index_bg_rho_lambda]*exp(-8.0)/a/a +
                                                p_tot+pvecback[pba->index_bg_rho_lambda]-pvecback[pba->index_bg_rho_lambda]*exp(-8.0)/a/a)*a
                                                + pba->K/a;
  }*/ //Approximation 1
  //Prueba_2
  //if(a<exp(-8.0)){
  ...
  //}
  //Aproximacion 2 17-06-21
  pvecback[pba->index_bg_H_prime] = - (3./2.) * (rho_tot-pvecback[pba->index_bg_rho_lambda]+pvecback[pba->index_bg_rho_lambda]/pow(a,pba->om_cmade) + p_tot
                                               +pvecback[pba->index_bg_rho_lambda]-pvecback[pba->index_bg_rho_lambda]/pow(a,pba->om_cmade)) * a + pba->K/a;
...
////////////////////////////////////////////////////////////////
    if(pba->has_lambda == _TRUE_)
      ...
      //CMADE
      //printf("For CMaDE we use Omega_cdm to fulfill Friedmann equation:\n");
      ...
      printf(" -> Omega_g = %g, wished %g\n",
             pvecback[pba->index_bg_rho_g]/pvecback[pba->index_bg_rho_crit], pba->Omega0_g);
      printf(" -> om_cmade = %g\n", pba->om_cmade);
      /////////////////////////////////////////////////
    if (pba->has_scf == _TRUE_){
