...
struct background
{
  ...
  double H_ini; /*Initial condition for CMADE Hubble*/
  double H_aux; /*-> Auxiliar variable for assign bi_H to bg_H for CMADE */
  double CMADE_aux; /*-> Auxiliar variable for the H_shooting_parameter for CMADE */
